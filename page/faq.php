		...
		<div class="content-1013">
			<div class="row">
				<div class="col-12 p-1 p-md-2">
					<div class="content-text"><?php echo get_field('faq_intro');?></div>
				</div>
			</div>
		</div>
	<?php }
			...
			<div class="row">
				<div class="col-12 p-2 p-md-4 faq-panels">
					<?php foreach ($faq_panels as $panel) { ?>
						<button type="button" class="mt-2 bg-pink text-uppercase text-left font-arial text-black btn-panel collapsed" data-toggle="collapse" data-target="#panel-<?php echo $npanel; ?>">
						...
						<div id="panel-<?php echo $npanel; ?>" class="collapse panel">
							<?php if($panel['questions']){
								...
								foreach ($questions as $question) { ?>
									<button type="button" class="<?php if($nquestion === 1) echo"first-question";?> text-left bg-white font-didot text-black btn-question collapsed" data-toggle="collapse" data-target="#question-<?php echo($npanel."-".$nquestion); ?>">
										<?php echo $question['question']; ?>
									</button>
									<div id="question-<?php echo($npanel."-".$nquestion); ?>" class="text-left collapse answer">
										<div class="p-1">
		...
		<div class="content-1013">
			<div class="row">
				<div class="col-12 p-2">
					<div class="content-text"><?php echo get_field('doc_intro');?></div>
				</div>
			</div>
		</div>
	<?php }
			...
			<div class="row">
				<div class="col-12 p-1 p-sm-2 p-md-4 faq-panels text-center">
					<?php foreach ($documents as $doc) { ?>
						<a class="mx-auto doc-link text-left text-orange font-arial bg-light-pink text-uppercase font-weight-bold d-block my-1" href="<?php echo $doc['document_file']['url']; ?>" download>
